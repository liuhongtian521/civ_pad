...
public class ScaleCircleNavigator extends View implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public ScaleCircleNavigator(Context context,int minRadius,int maxRadius,int circleSpacing) {
        super(context);
        init(context,minRadius,maxRadius,circleSpacing);
    }

    private void init(Context context,int minRadius,int maxRadius,int circleSpacing) {
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        mMinRadius = UIUtil.dip2px(context, minRadius);
        mMaxRadius = UIUtil.dip2px(context, maxRadius);
        mCircleSpacing = UIUtil.dip2px(context, circleSpacing);
